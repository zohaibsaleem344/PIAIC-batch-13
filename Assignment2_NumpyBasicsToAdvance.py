...
def function3():
    ...
    r = a[a%35==0] #wrtie your code here
    return r
    """
    Expected Output:
...
def function5():
    ...
    x = np.zeros((4,5)) #wrtie your code here
...
def function6():
    ...
    z = np.zeros(10) #wrtie your code here
    z[[4,7]] = 10, 20  
    return z
...
def function10():
    ...
    brr = np.array([1,2,3])
    y = np.subtract(arr.T,brr)  # write your code here 
...
def function11():
    ...
    s = np.where(arr%2!=0,-1,arr) #write your code here 
...
def function13():
    ...
    x = arr[(arr>5)&(arr<10)]  #write your code here 
...
def function14():
    ...
    x = np.split(arr,4) #write your code here 
...
def function15():
    ...
    x = arr[arr[:,1].argsort()] #write your code here 
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    z = np.dstack((x,y)) #write your code here 
